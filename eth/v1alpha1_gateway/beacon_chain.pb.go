...
var file_eth_v1alpha1_beacon_chain_proto_rawDesc = []byte{
	...
	0x41, 0x54, 0x4f, 0x52, 0x5f, 0x4b, 0x45, 0x59, 0x53, 0x10, 0x02, 0x32, 0xa3, 0x1e, 0x0a, 0x0b,
	...
	0x73, 0x12, 0x8d, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x4e, 0x65, 0x78, 0x74, 0x45, 0x70, 0x6f,
	0x63, 0x68, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16,
...
var file_eth_v1alpha1_beacon_chain_proto_depIdxs = []int32{
	...
	47, // 40: ethereum.eth.v1alpha1.BeaconChain.GetNextEpochProposerList:input_type -> google.protobuf.Empty
	...
	24, // 65: ethereum.eth.v1alpha1.BeaconChain.GetNextEpochProposerList:output_type -> ethereum.eth.v1alpha1.ValidatorAssignments
...
type BeaconChainClient interface {
	...
	GetNextEpochProposerList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ValidatorAssignments, error)
}
...
func (c *beaconChainClient) GetNextEpochProposerList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ValidatorAssignments, error) {
	out := new(ValidatorAssignments)
...
type BeaconChainServer interface {
	...
	GetNextEpochProposerList(context.Context, *empty.Empty) (*ValidatorAssignments, error)
}
...
func (*UnimplementedBeaconChainServer) GetNextEpochProposerList(context.Context, *empty.Empty) (*ValidatorAssignments, error) {
...
func _BeaconChain_GetNextEpochProposerList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconChainServer).GetNextEpochProposerList(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

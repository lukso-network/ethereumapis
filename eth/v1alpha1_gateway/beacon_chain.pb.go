...
var file_eth_v1alpha1_beacon_chain_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x6b, 0x73, 0x2f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x30, 0x01, 0x12, 0x85, 0x01,
	0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6e, 0x6f, 0x6e, 0x69, 0x63, 0x61, 0x6c, 0x42, 0x6c,
...
func (c *beaconChainClient) GetCanonicalBlock(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SignedBeaconBlock, error) {
...
func _BeaconChain_GetCanonicalBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconChainServer).GetCanonicalBlock(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

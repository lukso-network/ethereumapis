...
var (
	...
	pattern_BeaconChain_StreamMinimalConsensusInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"eth", "v1alpha1", "beacon", "consensus", "info", "stream"}, "", runtime.AssumeColonVerbOpt(true)))

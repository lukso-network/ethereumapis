...
type ShardTransition struct {
	...
	PandoraShardState          *PandoraShardState `protobuf:"bytes,6,opt,name=pandora_shard_state,json=pandoraShardState,proto3" json:"pandora_shard_state,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}           `json:"-"`
	XXX_unrecognized           []byte             `json:"-"`
	XXX_sizecache              int32              `json:"-"`
}
...
func (m *ShardTransition) GetPandoraShardState() *PandoraShardState {
	if m != nil {
		return m.PandoraShardState
	}
	return nil
}
...
var fileDescriptor_5d9da510e571288b = []byte{
	...
	,
}
...
func (m *ShardTransition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PandoraShardState != nil {
		{
			size, err := m.PandoraShardState.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ShardTransition) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PandoraShardState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PandoraShardState == nil {
				m.PandoraShardState = &PandoraShardState{}
			}
			if err := m.PandoraShardState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

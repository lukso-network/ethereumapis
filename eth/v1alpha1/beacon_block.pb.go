...
type BeaconBlockBody struct {
	...
	PandoraShard         []*PandoraShard        `protobuf:"bytes,9,rep,name=pandora_shard,json=pandoraShard,proto3" json:"pandora_shard,omitempty" ssz-max:"64"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *BeaconBlockBody) GetPandoraShard() []*PandoraShard {
	if m != nil {
		return m.PandoraShard
	}
	return nil
}
...
var fileDescriptor_6abbd9d98bd3d11a = []byte{
	...
	,
}
...
func (m *BeaconBlockBody) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PandoraShard) > 0 {
		for iNdEx := len(m.PandoraShard) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PandoraShard[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *BeaconBlockBody) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PandoraShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PandoraShard = append(m.PandoraShard, &PandoraShard{})
			if err := m.PandoraShard[len(m.PandoraShard)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
